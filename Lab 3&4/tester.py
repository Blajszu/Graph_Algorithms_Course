...
def test(alg_sol):
    ...
    graph_names = ["clique5", "clique20", "clique100", "cycle", "geo20_2b", "geo20_2c", "geo100_2a", "grid5x5", "mc1", "mc2", "path", "rand20_100", "rand100_500", "simple", "trivial"]
    ...
    for name in graph_names:
        ...
        V, L = loadDirectedWeightedGraph("Lab3/graphs-lab3/" + name)
        sol = readSolution("Lab3/graphs-lab3/" + name)

        # Pomiar czasu start
        start_time = time.time()
        res_value = int(alg_sol(V, L))
        end_time = time.time()
