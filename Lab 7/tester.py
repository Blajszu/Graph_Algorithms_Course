...
def test(alg_sol, directory):
    ...
    graph_names = list(filter(lambda x: x[0] != ".", listdir(f'Lab7/{directory}/')))
    ...
    for name in graph_names:
        ...
        V, L = loadDirectedWeightedGraph(f'Lab7/{directory}/{name}')
        sol = readSolution(f'Lab7/{directory}/{name}')
